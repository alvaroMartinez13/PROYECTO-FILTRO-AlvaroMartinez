...
Descripción.
El proyecto se sustenta según la necesidad de realizar un e-commerce de la empresa de Inmobiliaria ABC donde desean presentar un producto que pueda simplificar las
búsqueda de venta o arriendo de casas, apartaestudios o apartamentos. En donde se diferencia de las demás aplicaciones web para modo móvil donde puede simplificar la
búsqueda certera de la ubicación donde se desea solicitar el servicio, destacar una oferta de interés y poder encontrar de primera mano la oferta, en donde no solo
se puede ver la información simplificada sino esructurada y organizada para la vista del cliente.

Requerimientos.
1- Simplicar las áreas de proximidad de la ubicación en búsqueda.
2- Destactar las ofertas de interés y próximas en contactar.
3- Categorizar de manera personalizada las características de la búsqueda.
4- Estructurar la información detallada de la oferta.
5- Direccionar a un contacto directo con el que ofrece la demanda.
6- Realizar ofertas para la publicación a los interesados en solicitar servicio.
7- Implementar el uso de La aplicación web desde el modo móvil.
8- Notificar al usuario que no se tiene acceso disponible en estos momentos.
